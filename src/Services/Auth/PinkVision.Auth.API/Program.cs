...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("DoctorOnly", policy => policy.RequireRole("MEDECIN"));
    options.AddPolicy("PatientOnly", policy => policy.RequireRole("PATIENT"));
    options.AddPolicy("DoctorOrAdmin", policy => policy.RequireRole("ADMIN", "MEDECIN"));
});
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "PinkVision Auth API",
        Version = "v1",
        Description = "Service d'authentification JWT pour PinkVision"
    });
